...
analogWrite(pwm,90);   // Use only if you want to control the speed of dc motor
analogWrite(pwm1,90);   // Use only if you want to control the speed of dc motor
if (distance < 30)            
  {
    ...
    if(distance < 5)
      {
        digitalWrite(cright7, 0);  // Stopping
        digitalWrite(acright6, 0);
